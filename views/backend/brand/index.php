         ...
         <div class="card">
            <div class="card-header ">
               <div class="row">
                  <div class="col-md-6">
                     <div class="col-md-6">
                        <a class="btn btn-danger" href="index.php?option=brand&cat=trash">
                              ...
                              <?php if (count($list) > 0): ?>
                                 <?php foreach ($list as $item): ?>
                                    <tr class="datarow">
                                       ...
                                       <td>
                                          <img width="100px" src="../public/images/brand/<?= $item->image; ?>"
                                             alt="<?= $item->image; ?>">
                                       </td>
                                       <td>
                                          <div class="name">
                                          ...
                                          <div class="function_style">
                                             ...
                                             <?php endif; ?>
                                             <a href="index.php?option=brand&cat=edit&id=<?= $item->id; ?>">Chỉnh
                                                sửa</a> |
