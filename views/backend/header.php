...
<head>
    ...
    <link rel="stylesheet" href="/PhamQuocDuy_2122110045/public/plugins/fontawesome-free/css/all.min.css">
    <link rel="stylesheet" href="/PhamQuocDuy_2122110045/public/dist/css/adminlte.min.css">
    <link rel="stylesheet" href="/PhamQuocDuy_2122110045/public/datatables/css/dataTables.min.css">
    <link rel="stylesheet" href="/PhamQuocDuy_2122110045/public/css/backend.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" integrity="sha384-VCaYiTo0+QPgz2GKqLuwPOGc0wBog5oF5dJ3SBaPkj50G5C5cvbTk7U1G5Zs4HQRl" crossorigin="anonymous">
</head>
...
<body class="hold-transition sidebar-mini">
   <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
         <a href="index.php?option=backend/index.php" class="brand-link">
            <img src="/PhamQuocDuy_2122110045/public/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light">QUẢN TRỊ</span>
         </a>
         <div class="sidebar">
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
               <div class="image">
                  <img src="/PhamQuocDuy_2122110045/public/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
               </div>
               <div class="info">
