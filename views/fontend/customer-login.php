...
if(isset($_POST['dangnhap'])){
   ...
   if($user != null){
    ...
    $_SESSION['name'] = $user->name;
      ...
      header("Refresh: 3; URL=index.php?option=checkout");
   }else {
    $error = "Đăng nhập thất bại";
    header("Refresh: 2; URL=index.php?option=customer-login");
   }
}
                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <?php endif ?>
                            <div class="p-2">
                                <form class="form-horizontal" action="index.php?option=customer-login" method="POST">
                                    <div class="mb-3">
